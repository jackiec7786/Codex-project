...
export default async function Moderation(){
 ...
 return <div><h1 className="text-2xl font-bold">Moderation dashboard</h1>{reports.map((r: any)=><div key={r.id} className="my-2 rounded border p-3"><p>{r.reason}</p></div>)}</div>
}
